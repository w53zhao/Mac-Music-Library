...
$query="SELECT * FROM composer_description WHERE composer_id=$composer_id";
$result=mysql_query($query);
while($row = mysql_fetch_array($result)){
...
<td>
<textarea name ="description" rows="15" cols="50"><?php echo $description ?></textarea>
</td>
</tr>
